...
public class MinokamoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_minokamo);
        ...
        SharedPreferences preferences = getSharedPreferences("minokamo_data",MODE_PRIVATE);//保存したデータの名前とモードを渡す
        for(int i=0;i<10;i++) {
